...
**Visit:** The [Phaser website](https://phaser.io) and follow on [Twitter](https://twitter.com/phaser_) (#phaserjs)<br /> **Learn:** [API Docs](https://photonstorm.github.io/phaser3-docs/index.html), [Support Forum](https://phaser.discourse.group/) and [StackOverflow](https://stackoverflow.com/questions/tagged/phaser-framework)<br /> **Code:** 1700+ [Examples](https://phaser.io/examples) (source available in this [repo](https://github.com/photonstorm/phaser3-examples))<br /> **Read:** The [Phaser World](#newsletter) Newsletter<br /> **Chat:** [Slack](https://phaser.io/community/slack) and [Discord](https://phaser.io/community/discord)<br /> **Extend:** With [Phaser Plugins](https://phaser.io/shop/plugins)<br /> **Be awesome:** [Support](#support) the future of Phaser<br />
...
* Clone the git repository via [https](https://github.com/photonstorm/phaser.git), [ssh](git@github.com:photonstorm/phaser.git) or with the Github [Windows](github-windows://openRepo/https://github.com/photonstorm/phaser) or [Mac](github-mac://openRepo/https://github.com/photonstorm/phaser) clients.
* Download as [zip](https://github.com/photonstorm/phaser/archive/master.zip)
* Download the build files: [phaser.js](https://github.com/photonstorm/phaser/releases/download/v3.19.0/phaser.js) and [phaser.min.js](https://github.com/photonstorm/phaser/releases/download/v3.19.0/phaser.min.js)
...
The [Contributors Guide](https://github.com/photonstorm/phaser/blob/master/.github/CONTRIBUTING.md) contains full details on how to help with Phaser development. The main points are:

- Found a bug? Report it on [GitHub Issues](https://github.com/photonstorm/phaser/issues) and include a code sample. Please state which version of Phaser you are using! This is vitally important.
...
Written something cool in Phaser? Please tell us about it in the [forum](https://phaser.discourse.group/), or email support@phaser.io
